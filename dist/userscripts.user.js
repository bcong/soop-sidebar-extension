...
(function () {
  ...
  async function fetchChzzkUserId() {
    var _a2, _b2, _c;
    const cached = _GM_getValue("chzzkUserId_cached", "");
    ...
    try {
      ...
      const channelId = ((_a2 = json == null ? void 0 : json.content) == null ? void 0 : _a2.channelId) ?? ((_c = (_b2 = json == null ? void 0 : json.content) == null ? void 0 : _b2.channel) == null ? void 0 : _c.channelId) ?? null;
      if (channelId) {
        _GM_setValue("chzzkUserId_cached", channelId);
      }
      return channelId;
    } catch {
      return null;
  ...
  async function kvdbPush(chzzkUserId, pins) {
    return;
  }
  async function kvdbPull(chzzkUserId) {
    return [];
  }
  function isKvdbConfigured() {
  ...
  const SettingModal = observer(() => {
    ...
    const version = (typeof GM_info !== "undefined" ? (_a2 = GM_info == null ? void 0 : GM_info.script) == null ? void 0 : _a2.version : "") || "20260524171501";
