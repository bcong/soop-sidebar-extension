...
(function () {
      ...
      "a",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "username", children: [
            isNotified && !isPinned && /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa fa-bell", style: { marginRight: 3, fontSize: 11 } }),
            channel.user_nick
          ] }),
  ...
  const SettingModal = observer(() => {
    ...
    const version = (typeof GM_info !== "undefined" ? (_a2 = GM_info == null ? void 0 : GM_info.script) == null ? void 0 : _a2.version : "") || "20260523233253";
