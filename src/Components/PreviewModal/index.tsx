...
export const openPreviewModal = (props: Omit<PreviewModalProps, "onClose">): void => {
    globalOpenFn?.(props);
};

// 실제 모달 내용
const PreviewModalContent: React.FC<PreviewModalProps> = ({ broadNo, userId, userNick, broadTitle, onClose }) => {
...
const PreviewModal: React.FC = () => {
    const [modalProps, setModalProps] = useState<Omit<PreviewModalProps, "onClose"> | null>(null);
    ...
    return <PreviewModalContent {...modalProps} onClose={() => setModalProps(null)} />;
};
