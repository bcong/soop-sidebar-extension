...
export const isUserBlocked = (userId: string, blockedUsers: I_BlockedUser[]): boolean =>
...
export const isCategoryBlocked = (categoryId: string, blockedCategories: I_BlockedCategory[]): boolean =>
    blockedCategories.some((c) => c.categoryId === categoryId);
...
export const isCategoryPinned = (categoryId: string, pinnedCategories: I_PinnedCategory[]): boolean =>
    pinnedCategories.some((c) => c.categoryId === categoryId);
