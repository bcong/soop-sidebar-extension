...
export const getElapsedTime = (broadcastStartTimeText: string, type: "HH:MM:SS" | "HH:MM"): string => {
...
export const getCategoryName = (targetCateNo: string, savedCategory: I_CategoryData | null): string => {
...
export const getCategoryNo = (targetCateName: string, savedCategory: I_CategoryData | null): string => {
    if (!savedCategory) return "";
